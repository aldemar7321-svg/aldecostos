...
const formSchema = z.object({
  product: z.string().min(1, 'El nombre del ingrediente es requerido.'),
...
const InventoryContent = () => {
  ...
  const handleAddNew = () => {
    setEditingItem(null);
    form.reset({ product: '', purchaseQuantity: 1, measure: 'g', value: 0, unitValue: 0 });
    setIsSheetOpen(true);
  };
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Lista de Precios de Ingredientes</CardTitle>
          <CardDescription>
          ...
          <SheetHeader>
            ...
            <SheetDescription>
              {editingItem
                ...
                : 'Completa los detalles del nuevo ingrediente.'}
            </SheetDescription>
          </SheetHeader>
          <Form {...form}>
            <form
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Ej: Melaza de caña" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
