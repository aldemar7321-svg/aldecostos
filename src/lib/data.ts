...
export const ingredientsData: PriceList[] = [
    ...
    { id: 'ing-2', product: 'Harina de rocas', purchaseQuantity: 1, measure: 'kg', value: 2000, unitValue: 2 },
    { id: 'ing-3', product: 'Agua', purchaseQuantity: 1, measure: 'l', value: 50, unitValue: 0.05 },
];
...
export const productsData: Product[] = [
  {
    ...
    ingredients: [
      ...
      { ingredientId: 'ing-3', quantity: 43000 },
    ],
    packaging: [
...
export const transportData: TransportItem[] = [
  { id: 'trans-1', concept: 'Distribución Local', monthlyValue: 30000, productionPercentage: 1, allocationBasis: 'labor' },
];
